...
import { ShieldCheck, Leaf, CheckCircle, Scale, Users, HandHeart, CircleDollarSign, Info } from 'lucide-react';
        ...
        <div className="flex justify-between items-center">
          <CardTitle className="flex items-center text-lg text-card-foreground">
            <span className="relative mr-2">
              ...
              <Leaf className="w-3.5 h-3.5 text-green-700 absolute -bottom-1 -right-1 opacity-90" />
            </span>
      ...
      <CardContent>
        <div className="text-sm text-card-foreground/90 space-y-3">
          ...
          <ul className="list-none space-y-1.5 pl-2 text-xs text-muted-foreground">
            <li className="flex items-start"><CircleDollarSign className="w-3.5 h-3.5 mr-2 mt-0.5 shrink-0 text-green-500" /> Fair wages & local employment practices.</li>
            <li className="flex items-start"><HandHeart className="w-3.5 h-3.5 mr-2 mt-0.5 shrink-0 text-green-500" /> Animal welfare standards for any wildlife interactions.</li>
            <li className="flex items-start"><Users className="w-3.5 h-3.5 mr-2 mt-0.5 shrink-0 text-green-500" /> Impact on over-tourism and local communities.</li>
            <li className="flex items-start"><Leaf className="w-3.5 h-3.5 mr-2 mt-0.5 shrink-0 text-green-500" /> Environmental footprint (e.g., plastic use, energy sources).</li>
            <li className="flex items-start"><Info className="w-3.5 h-3.5 mr-2 mt-0.5 shrink-0 text-green-500" /> Genuine community support and cultural preservation.</li>
          </ul>
          <p className="mt-2">
          ...
          <div className="flex items-center justify-center py-2 gap-3 mt-3">
            <Scale className="w-7 h-7 text-green-500/50 animate-pulse" />
            <CheckCircle className="w-8 h-8 text-primary/40 absolute animate-ping" style={{ animationDuration: '3.2s' }}/>
          </div>
