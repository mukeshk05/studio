...
const features = [
    ...
    {
      icon: <BookOpenTextIcon className="w-10 h-10 mb-4 text-accent" />,
    ...
    {
      icon: <ListPlusIcon className="w-10 h-10 mb-4 text-primary" />,
    ...
    {
      icon: <ScanSearchIcon className="w-10 h-10 mb-4 text-accent" />,
